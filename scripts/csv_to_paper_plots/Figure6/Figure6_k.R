...
# Read in data
#=====================
#illumina_20_way_df <- fread("ROC_data_20_way_illumina.R_data.csv", header=TRUE)
illumina_20_way_df <- fread("20wayROC/ROC_data_20_way_illumina.R_data.csv", header=T, sep=",")
nanopore_20_way_df <- fread("20wayROC/ROC_data_20_way_nanopore.R_data.csv",header=T, sep=",")
precision_per_sample_illumina_df <- read.csv("precision_per_sample/precision_per_sample_illumina.csv", header=TRUE)
precision_per_sample_nanopore_df <- read.csv("precision_per_sample/precision_per_sample_nanopore.csv", header=TRUE)
...
ggsave(final_plot, file="fig6_k.png", width=15, height=10, dpi=300)
