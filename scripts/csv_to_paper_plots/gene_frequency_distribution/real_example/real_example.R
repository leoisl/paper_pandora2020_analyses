...
ggsave(count_plot, file="real_example.count.png", width=7, height=5, dpi=300)
...
ggsave(proportion_plot, file="real_example.proportion.png", width=7, height=5, dpi=300)
